...
<body id="top">
    ...
    <center>
      ...
      <h3>Documentação python</h3>  
      <b><a href="https://docs.python.org/pt-br/3/tutorial/" target="_blank">Clique aqui para começar</a>
     
     </center>
     
          <center>
         
                <h3>Video aulas Python</h3>  
                <b><a href="https://www.youtube.com/watch?v=S9uPNppGsGo&list=PLHz_AreHm4dlKP6QQCekuIPky1CiwmdI6" target="_blank">Clique aqui para começar</a>
     
          </center>

        <center>
               <img src = "img/python3.png" alt = "unnamed" style = "width: 50%">
        </center>  
